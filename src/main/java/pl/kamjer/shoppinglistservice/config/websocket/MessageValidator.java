...
public class MessageValidator {
    ...
    private static final List<Message.Header> CONNECT_REQUIRED_HEADER = List.of();
    private static final List<Message.Header> CONNECTED_REQUIRED_HEADER = List.of(ID);
    private static final List<Message.Header> SUBSCRIBE_REQUIRED_HEADER = List.of(DEST);
    private static final List<Message.Header> SUBSCRIBED_REQUIRED_HEADER = List.of();
    private static final List<Message.Header> UNSUBSCRIBE_REQUIRED_HEADER = List.of(DEST);
    private static final List<Message.Header> UNSUBSCRIBED_REQUIRED_HEADER = List.of();
    private static final List<Message.Header> MESSAGE_REQUIRED_HEADER = List.of(ID, DEST, BODY);
    private static final List<Message.Header> ERROR_REQUIRED_HEADER = List.of(BODY);
